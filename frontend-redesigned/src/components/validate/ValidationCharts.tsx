    ...
    >
      ...
      <div
        style={{
          ...
          height: '320px',
          background:
            'linear-gradient(180deg, rgba(87,201,230,0.035) 0%, rgba(87,201,230,0) 55%), var(--color-abyss)',
          border:
