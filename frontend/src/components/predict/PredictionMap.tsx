...
export function PredictionMap({ lat, lon, onLocationChange }: PredictionMapProps) {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '240px', borderRadius: 'var(--radius-md)', overflow: 'hidden', border: '1px solid var(--color-border)', flexShrink: 0 }}>
      <div ref={mapContainer} style={{ width: '100%', height: '100%' }} />
      <div style={{ position: 'absolute', bottom: 'var(--space-2)', right: 'var(--space-2)', pointerEvents: 'none' }}>
        <div className="label-scientific" style={{ fontSize: '0.65rem', backgroundColor: 'rgba(6,20,29,0.8)', padding: '4px 6px', borderRadius: '4px', color: 'var(--color-text-subtle)' }}>
