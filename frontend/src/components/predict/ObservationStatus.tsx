...
export function ObservationStatus({ availability }: { availability: AvailabilityResponse | null }) {
  ...
  return (
    <div style={{ marginTop: 'var(--space-4)', padding: 'var(--space-4)', backgroundColor: 'rgba(6, 20, 29, 0.4)', borderRadius: 'var(--radius-md)', border: `1px solid ${isReady ? 'var(--color-teal)' : isPartial ? 'var(--color-ocean)' : 'var(--color-danger)'}` }}>
