      ...
      >
        <defs>
          ...
          <linearGradient id={`${gradientId}-line`} x1="0" y1="0" x2="0" y2="1">
            ...
            <stop offset="100%" stopColor="#3E82A3" />
          </linearGradient>
        </defs>
        ...
        {selectedPoint && (
          <g style={{ transition: 'all var(--transition-normal)' }}>
            <line
              ...
              stroke="var(--color-ocean-bright)" strokeWidth="1" strokeOpacity="0.45"
            />
            <line
              x1={scaleX(selectedPoint.temp)} y1={scaleY(selectedPoint.depth)}
              x2={scaleX(selectedPoint.temp)} y2={height - padding.bottom}
              stroke="var(--color-ocean-bright)" strokeWidth="1" strokeOpacity="0.25"
              strokeDasharray="2 3"
            />
          </g>
        )}
        ...
        {/* The profile line */}
        <path
          d={linePath} fill="none" stroke={`url(#${gradientId}-line)`}
        ...
        {data.map(d => {
          ...
          return (
            <circle
              ...
              cy={scaleY(d.depth)}
              r={isSelected ? 4.5 : 2}
              fill={isSelected ? 'var(--color-ocean-bright)' : 'var(--color-panel)'}
              stroke={isSelected ? 'var(--color-ink)' : 'var(--color-ocean)'}
